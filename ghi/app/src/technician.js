    ...
    <div className="col">
        ...
        <form onSubmit={this.handleSubmit} id="create-technician-form">
            ...
            <div className="mb-3">
                ...
                <div className="form-floating mb-3">
                <input onChange={this.handleNumberChange} value={this.state.employeeNumber} required placeholder="Number" type="number" name="employee-number" id="number" className="form-control" />
